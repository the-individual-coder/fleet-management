          ...
          <div className="flex items-center py-2">
            ...
            <ol className="ms-3 flex items-center whitespace-nowrap">
              ...
              >
                ...
                :breadCrumb == "vehicles-reservations" ?
                <>
                                           <li>
                <svg
                  className="shrink-0 mx-3 overflow-visible size-2.5 text-gray-400 dark:text-neutral-500"
                 ...
                 <li>
                  ...
                  <li>
                    <Link
                      className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-white"
                      to="/maintenances"
                      onClick={()=>{setBreadCrumb("maintenances")}}
                    >
  ...
  <g id="SVGRepo_iconCarrier">
    ...
    <style
      ...
      dangerouslySetInnerHTML={{
        __html:
          " .st0{display:none;} .st1{display:inline;opacity:0.93;} .st2{display:inline;} .st3{fill:none;stroke:#1f2937;stroke-width:15;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;} .st4{display:inline;fill:none;stroke:#1f2937;stroke-width:15;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;} .st5{fill:#1f2937;} .st6{fill:#1f2937;} .st7{fill:#1f2937;} .st8{fill:#1f2937;} .st9{fill:#1f2937;} .st10{fill:#1f2937;} .st11{fill:#1f2937;} "
      }}
    />{" "}
      ...
      <g className="st2">
        ...
        />{" "}
                  ...
                  <li>
                    <Link
                      className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-white"
                      to="/vehicles-reservations"
                      onClick={()=>{setBreadCrumb("vehicles-reservations")}}
                    >
      ...
      <path d="M391.076,0H104.224C82.542,0,64.902,17.64,64.902,39.323c0,0,0.003,332.512,0.003,332.514 c0,21.68,17.638,39.318,39.318,39.318h22.913v44.823h55.897v-44.823h208.037L391.076,0z M376.076,332.506H111.724V15h264.352 V332.506z M96.724,16.189v317.032c-6.142,1.18-11.883,3.811-16.822,7.715V39.323C79.902,28.528,86.973,19.358,96.724,16.189z M104.223,396.155c-13.409,0-24.318-10.909-24.318-24.318c0-6.505,2.529-12.617,7.122-17.209 c4.592-4.592,10.699-7.121,17.196-7.121h22.913v48.648H104.223z M142.136,440.978v-93.472h25.897v93.472H142.136z M376.071,396.155 H183.034v-48.648h193.037V396.155z" />{" "}
                  ...
                  <li>
                    <Link
                      className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-white"
                      to="/vendor-requests"
                      onClick={()=>{setBreadCrumb("vendor-requests")}}
                    >
    ...
    />
                  ...
                  <li>
                    <Link
                      className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-white"
                      to="/vehicles"
                      onClick={()=>{setBreadCrumb("vehicles")}}
                    >

<svg fill="#1f2937" viewBox="0 0 24 24" width={18} height={18} xmlns="http://www.w3.org/2000/svg">
  <g id="SVGRepo_bgCarrier" strokeWidth={0} />
  <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" />
  <g id="SVGRepo_iconCarrier">
